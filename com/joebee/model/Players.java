...
public class Players {
    ...
    public void printPlayers() {
      ...
      for(Player p: mPlayers) {
        String previousExperience = p.previouslyExperienced();
        System.out.printf("Player #%d: %s %s - Standing at %d inches tall, and is %s%n", mPlayers.indexOf(p) + 1, p.getFirstName(), p.getLastName(), p.getHeightInInches(), previousExperience);
      }
