  ...
  private static final long serialVersionUID = 1L;
   ...
   private String mFirstName;
    ...
    public Player(String firstName, String lastName, int heightInInches, boolean previousExperience) {
        ...
        if (heightInInches < 39) { this.mHeightEvaluation = "Shorter Than Average";
        } else if (heightInInches >= 39 && heightInInches <= 42) {
            this.mHeightEvaluation = "Average";
        } else {
            this.mHeightEvaluation = "Taller Than Average";
        }
    }
    ...
    public String previouslyExperienced() {
    String previousExperience = "";
        if(this.isPreviousExperience() == true) {
          previousExperience = "experienced.";
        }else {
          previousExperience = "not experienced.";
        }
